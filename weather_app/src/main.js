...
function renderWeather({current, daily, hourly}) {
    ...
    document.body.classList.remove("blurred") // Unblur after done rendering
}

function setValue(selector, value, {parent = document} = {}) {
    parent.querySelector(`[data-${selector}]`).textContent = value;  // Select by attribute `data-...`
}
...
function renderHourlyWeather(hourly) {
    ...
    hourly.forEach(hour => {
        ...
        setValue("fl-temp", hour.FL, {parent: element});
